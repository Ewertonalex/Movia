...
/** Marca gráfica do MOVIA: linhas de movimento saindo de um corpo em deslocamento. */
export function MoviaMark({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 32 32"
      role="img"
    ...
    >
      <defs>
        <linearGradient id="movia-mark-gradient" x1="0" y1="0" x2="1" y2="1">
